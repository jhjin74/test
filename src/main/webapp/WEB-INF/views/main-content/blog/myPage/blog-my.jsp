...
<body>
	<div class="row">
				...
				<li><a href="#" id="blog-category2"><i
					...
					<div class="sub-category-sub" style="display:none">
						<ul class="sub-category-category">
							<li id="category_freeboard"><a onclick="onChangeCategory('Freeboard');">자유게시판</a></li>
							<li id="category_upbit"><a onclick="onChangeCategory('upbitboard');">업비트</a></li>
							<li id="category_bithumb"><a onclick="onChangeCategory('bithumbboard');">빗썸</a></li>
							<li id="category_coinone"><a onclick="onChangeCategory('coinoneboard');">코인원</a></li>
						</ul>
					</div></li>
		...
		<div class="main">
			<h2>내 게시글</h2>
			<div class="">
				<table id="blog_my_table" class="main-table">
