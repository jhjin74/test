...
<body>
	...
	<div class="exchange_table">
		<div class="exchange_change">
			<span class="exchange_name">비트업 시세</span>
			<a href="http://localhost:8080/exchange/upbit" class="button12"> <em>
				</em> <span> Upbit </span>
			</a>
		</div>
